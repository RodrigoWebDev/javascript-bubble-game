$(function () {
  ...
  $(".play").on("click", function () {
    ...
    function addBubble() {
      //Create the bubble
      var bubble = $(
        '<img class="bubble" src="https://vignette.wikia.nocookie.net/tudosobrehoradeaventura/images/d/d4/Bolha.png/revision/latest?cb=20130908150958&path-prefix=pt-br" alt="bubble">'
      );
